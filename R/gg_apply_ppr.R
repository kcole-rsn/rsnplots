#' A [ggplot2] theme formatted in the Refugee Solidarity Network style for PPR reports
#'
#' \code{gg_apply_ppr} provides a [ggplot2] theme formatted according to the
#' Program Progress Report (PPR) guidelines.
#'
#' @import extrafont
#' @import ggrepel
#' @md
...
gg_apply_ppr <- function(base_size = 8.5, base_family = "Open Sans",
                         base_line_size = 0.5,
                         base_rect_size = 0.5) {
    ...
    ggplot2::theme(
        ...
        axis.title.y = ggplot2::element_text(
            angle = 90L,
            margin = ggplot2::margin(r = 10L, l = 4L)
        ),
        ...
        panel.grid.major.y = ggplot2::element_line(colour = "#dedddd", linetype = "dashed"),
